...
/* Header files should include the following information:
   ...
   Never implement the body of functions in a .h file */
...
class course
{
    ...
    private:
       ...
       char last_name[SIZE];
       //Place the reset of the data members here:
       char crn[COURSE_SIZE];
       char course_des[COURSE_SIZE];
       char section[COURSE_SIZE];
